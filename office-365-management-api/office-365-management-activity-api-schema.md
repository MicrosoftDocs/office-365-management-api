...
|ListBaseTemplateType|Edm.String|No|Gets the list definition type on which the list is based.|
|IsHiddenList|Edm.Boolean|No|This value is true if the SharePoint list is hidden.|
|IsDocLib|Edm.Boolean|No|This value is true if the SharePoint list is of type Document Library.|
|||||
