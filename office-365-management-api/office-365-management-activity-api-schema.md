...
|ErrorCode|Edm.String|No|For failed logins, contains the Azure AD AADSTS error code. Refer to the list of [Authentication and authorization error codes](https://docs.microsoft.com/azure/active-directory/develop/reference-aadsts-error-codes#aadsts-error-codes).|
|LogonError|Edm.String|No|For failed logins, contains a user-readable description of the reason for the failed login.
|||||
