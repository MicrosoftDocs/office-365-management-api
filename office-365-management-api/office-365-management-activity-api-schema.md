...
|RecordType     | The type of operation indicated by the record. See the AuditLogRecordType table for details on the types of audit log records. Here we only list the relevant MIP Record types.|
